...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "alicoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1634864227;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 9914974;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x58590cdb5ac261b68cbc180b65539f35a2f80673eecca8214e1fa5907ac9cc92"));
        assert(hashGenesisBlock == uint256("0x0000015b81a0bd0f5f23b36bb75adb22632eb9a046ce74bb2c5c0c89f6ee93b0"));
     
	vSeeds.push_back(CDNSSeedData("198.13.53.44","198.13.53.44"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x58590cdb5ac261b68cbc180b65539f35a2f80673eecca8214e1fa5907ac9cc92"));
        assert(hashGenesisBlock == uint256("0x000027b6e3a008cd9ad3be7153ed29986e7d6409ad7d30e69f7f3edc4f41465b"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x58590cdb5ac261b68cbc180b65539f35a2f80673eecca8214e1fa5907ac9cc92"));
        assert(hashGenesisBlock == uint256("0x548efb32067475f8b6868b644d4f17b4418976ed3386584e94b1284df0e9857d"));
