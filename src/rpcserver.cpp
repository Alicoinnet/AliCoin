...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "alicoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* alicoin features */
        {"alicoin", "masternode", &masternode, true, true, false},
        {"alicoin", "listmasternodes", &listmasternodes, true, true, false},
        {"alicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"alicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"alicoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"alicoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"alicoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"alicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"alicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"alicoin", "startmasternode", &startmasternode, true, true, false},
        {"alicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"alicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"alicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"alicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"alicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"alicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"alicoin", "mnbudget", &mnbudget, true, true, false},
        {"alicoin", "preparebudget", &preparebudget, true, true, false},
        {"alicoin", "submitbudget", &submitbudget, true, true, false},
        {"alicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"alicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"alicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"alicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"alicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"alicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"alicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"alicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"alicoin", "mnsync", &mnsync, true, true, false},
        {"alicoin", "spork", &spork, true, true, false},
        {"alicoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> alicoin-cli " + methodname + " " + args + "\n";
}
