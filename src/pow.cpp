...
{
    /* current difficulty formula, alicoin - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
...
unsigned int GetLegacyNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock, bool fProofOfStake)
{
    ...
    // alicoin coin: target change every block
    // alicoin coin: retarget with exponential moving toward target spacing
    uint256 bnNew;
