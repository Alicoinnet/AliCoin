...
/** Utility functions used by the alicoin Qt UI.
 */
namespace GUIUtil
{
...
// Render alicoin addresses in monospace font
...
// Parse "alicoin:" URI into recipient object, return true on successful parsing
