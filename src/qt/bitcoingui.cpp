                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Alicoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&alicoin Project"), this);
    webmainAction->setStatusTip(tr("alicoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("alicoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("alicoin Twitter"));
    ...
    discordAction->setStatusTip(tr("alicoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("alicoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("alicoin Telegram"));
    ...
    redditAction->setStatusTip(tr("alicoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap alicoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell alicoin Coin (alicoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    alicoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&alicoin block explorer"), this);
    alicoinBlockExplorerAction->setStatusTip(tr("alicoin blockchain explorer"));
    alicoinBlockExplorerAction->setToolTip(alicoinBlockExplorerAction->statusTip());
    alicoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&alicoin Project Github"), this);
    githubAction->setStatusTip(tr("alicoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a alicoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alicoin: URIs)"));
...
//    }
    ...
    connect(alicoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(alicoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About alicoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about alicoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for alicoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your alicoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified alicoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a alicoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the alicoin Core help message to get a list with possible alicoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(alicoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("alicoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.alicoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/alicoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/alicoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/alicoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/alicoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::alicoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/alicoin/alicoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to alicoin network", "", count));
}
...
{
    QString strTitle = tr("alicoin Core"); // default title
