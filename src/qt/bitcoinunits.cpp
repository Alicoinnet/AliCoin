...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case alicoin:
        return QString("ALICN");
    case mECA:
        return QString("mALICN");
    case uECA:
        return QString::fromUtf8("uALICN");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mECA:
            return QString("mALICN");
        case uECA:
            return QString::fromUtf8("μALICN");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case alicoin:
            return QString("tALICN");
        case mECA:
            return QString("mtALICN");
        case uECA:
            return QString::fromUtf8("μtALICN");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case alicoin:
            return QString("ALICN");
        case mECA:
            return QString("Milli-ALICN (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-ALICN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case alicoin:
            return QString("TestDOJAs");
        case mECA:
            return QString("Milli-TestDRAW (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestDRAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
