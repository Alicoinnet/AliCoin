...
/* alicoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "alicoin"
#define QAPP_ORG_DOMAIN "alicoinproject.org"
#define QAPP_APP_NAME_DEFAULT "alicoin-Qt"
#define QAPP_APP_NAME_TESTNET "alicoin-Qt-testnet"
