...
RESOURCES += src/qt/alicoin.qrc src/qt/alicoin_locale.qrc

TRANSLATIONS += src/qt/locale/alicoin_bg.ts \
                src/qt/locale/alicoin_de.ts \
                src/qt/locale/alicoin_en.ts \
                src/qt/locale/alicoin_es.ts \
                src/qt/locale/alicoin_fi.ts \
                src/qt/locale/alicoin_fr.ts \
                src/qt/locale/alicoin_it.ts \
                src/qt/locale/alicoin_ja.ts \
                src/qt/locale/alicoin_pl.ts \
                src/qt/locale/alicoin_pt.ts \
                src/qt/locale/alicoin_ru.ts \
                src/qt/locale/alicoin_sk.ts \
                src/qt/locale/alicoin_sv.ts \
                src/qt/locale/alicoin_vi.ts \
                src/qt/locale/alicoin_zh_CN.ts \
                src/qt/locale/alicoin_zh_TW.ts
