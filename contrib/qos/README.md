...
This means one can have an always-on alicoind instance running, and another local alicoind/alicoin-qt instance which connects to this node and receives blocks from it.
