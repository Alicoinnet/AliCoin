Contributing to alicoin Core
============================

The alicoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the alicoin Core project, and is not to be
confused with overall alicoin Network Protocol consensus changes.

Whether a pull request is merged into alicoin Core rests with the project merge
...
Patches that change alicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the alicoin consensus, it must have been
...
The project leader is the release manager for each alicoin Core release.
