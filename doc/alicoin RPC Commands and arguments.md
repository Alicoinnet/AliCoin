# alicoin RPC Commands and arguments
...
The configuration file is not automatically created; you can create it using your favorite plain-text editor. By default, alicoin-qt (or alicoind) will look for a file named alicoin.conf in the alicoin data directory, but both the data directory and the configuration file path may be changed using the -datadir and -conf command-line arguments.

| Platform	   |Path to data folder           | Typical path to configuration file                                                 |
|------------|--------------------------------|------------------------------------------------------------------------------------|
| Linux	     | ~/	                            | /home/username/.alicoin/alicoin.conf                                               |
| macOS      | ~/Library/Application Support/	| /Users/username/Library/Application Support/Eletra/alicoin.conf                    |
| Windows	   | %APPDATA%	                    | (Vista-10) C:\Users\username\AppData\Roaming\alicoin\alicoin.conf                  |
|            |                                | (2000-XP) C:\Documents and Settings\username\Application Data\alicoin\alicoin.conf |

Note: if running alicoin in testnet mode, the sub-folder testnet will be appended to the data directory automatically. Command line arguments

## These commands are accurate as of alicoin Core version 2.0.0:
...
Start alicoin Core Daemon with option:
<table>
<tr> <td>alicoind</td><td>[options]</td></tr>
</table>
...
<tr> <td>--conf=<file></td><td>Specify configuration file (default: alicoin.conf)</td></tr>
...
<tr> <td>--pid=<file></td><td>Specify pid file (default: alicoind.pid)</td></tr>
...
<tr> <td>--reindexmoneysupply</td><td>Reindex the alicoin and zECA money supply statistics on startup</td></tr>
...
<tr> <td>--paytxfee=<amt></td><td>Fee (in alicoin/kB) to add to transactions you send (default: 0.00)
...
<tr> <td>--minrelaytxfee=<amt></td><td>Fees (in alicoin/Kb) smaller than this are considered zero fee for relaying (default: 0.0001)
...
<tr> <td>-litemode=<n></td><td>Disable all alicoin specific functionality (Masternodes, Zerocoin, wiftX, Budgeting) (0-1, default: 0)
</table>
...
<tr> <td>--ecastake=<n></td><td>Enable or disable staking functionality for alicoin inputs (0-1, default: 1)
...
This documentation lists all available RPC commands as of alicoin version 2.0.0, and limited documentation on what each command does. For full documentation of arguments, results and examples, type help ( “command” ) to view full details at the console. You can enter commands either from Tools > Debug console in the QT wallet, or using alicoin-cli
...
#### debug ( 0 | 1 | addrman | alert | bench | coindb | db | lock | rand | rpc | selectcoins | mempool | mempoolrej | net | proxy | prune | http | libevent | alicoin )
...
#### preparebudget "proposal-name" "url" payment-count block-start "alicoin-address" monthy-payment
...
#### submitbudget "proposal-name" "url" payment-count block-start "alicoin-address" monthy-payment "fee-tx"
...
PoW Only: Return if the server is set to generate coins or not. The default is false. It is set with the command line argument -gen (or alicoin.conf setting gen) It can also be set with the setgenerate call.
...
#### validateaddress “alicoinaddress”

Return information about the given alicoin address.

#### verifymessage “alicoinaddress” “signature” “message”
...
#### bip38decrypt "alicoinaddress" "passphrase"

Decrypts and then imports password protected private key.

#### bip38encrypt "alicoinaddress" "passphrase"

Encrypts a private key corresponding to 'alicoinaddress'.

#### dumpprivkey “alicoinaddress”

Reveals the private key corresponding to ‘alicoinaddress’. Then the importprivkey can be used with this output
...
DEPRECATED. Returns the current alicoin address for receiving payments to this account.
...
Returns a new alicoin address for receiving payments. If ‘account’ is specified (DEPRECATED), it is added to the address book so payments received with the address will be credited to ‘account’.

#### getrawchangeaddress

Returns a new alicoin address, for receiving change. This is for use with raw transactions, NOT normal use.

#### getreceivedbyaccount “account” ( minconf addlockconf )

DEPRECATED. Returns the total amount received by addresses with <account> in transactions with specified minimum number of confirmations.

#### getreceivedbyaddress “alicoinaddress” ( minconf addlockconf )

Returns the total amount received by the given alicoinaddress in transactions with specified minimum number of confirmations.
...
#### importprivkey “alicoinprivkey” ( “label” rescan )
...
#### sendfrom “fromaccount” “toalicoinaddress” amount ( minconf addlockconf “comment” “comment-to” )

DEPRECATED (use sendtoaddress). Sent an amount from an account to a alicoin address.
...
#### sendtoaddress “alicoinaddress” amount ( “comment” “comment-to” subtractfeefromamount use_is use_ps )
...
Stores the wallet decryption key in memory for ‘timeout’ seconds. This is needed prior to performing transactions related to private keys such as sending alicoins
...
Usage:
  alicoin-tx [options] <hex-tx> [commands]  Update hex-encoded alicoin transaction
  alicoin-tx [options] -create [commands]   Create hex-encoded alicoin transaction
