...
In order to support loading of multiple wallets in alicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is alicoin.cpp.
...
Changes to alicoin.cpp
----------------------
alicoin.cpp is the entry point into alicoin-qt, and as such, will require some minor modifications to provide hooks for
